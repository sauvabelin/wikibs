...
$wgAuth    = new NetBSAuth([
    'host'              => $wgDBserver,
    'database'          => getenv("AUTH_DB_NAME"),
    'username'          => $wgDBuser,
    'password'          => $wgDBpassword,
    'table'             => getenv("AUTH_TABLE_NAME"),
    'usernameColumn'    => getenv("DB_USERNAME_COL"),
    'hashColumn'        => getenv("DB_PASS_COL"),
    'saltColumn'        => getenv("DB_SALT_COL"),
    'adminColumn'		=> getenv("DB_ADMIN_COL"),
    'bcrypt_cost'       => intval(getenv("BCRYPT_COST"))
]);
